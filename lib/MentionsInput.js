...
var MentionsInput = (_temp = _class = function (_React$Component) {
  ...
  onRemove: function onRemove(mentions) {
    return null;
  }
  ...
  this.handleChange = function (ev) {
    ...
    var prevMentions = (0, _utils.getMentions)(_this3.props.value, markup, displayTransform, regex);
    var mentions = (0, _utils.getMentions)(newValue, markup, displayTransform, regex);

    // Check for removed mentions
    var removed = prevMentions.filter(function (mention) {
      return !Boolean(mentions.find(function (newMention) {
        return newMention.id === mention.id && newMention.display === mention.display;
      }));
    ...
    // Call onRemove
    if (removed.length > 0 && _this3.props.onRemove) {
      _this3.props.onRemove(removed);
    }
